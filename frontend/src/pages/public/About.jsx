  ...
  return (
    <div className={`container ${styles.page}`}>
      ...
      <ul className={styles.socialList}>
        <li>
          <a href={STORE.instagramUrl} target="_blank" rel="noreferrer" className={styles.socialLink}>
            <svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true" className={styles.socialIcon}>
