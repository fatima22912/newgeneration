...
const NAV_LINKS = [
  ...
  { to: "/admin/comptes-proprietaires", label: "Comptes propriétaires" },
  { to: "/admin/journal-activite", label: "Journal d'activité" },
  { to: "/admin/statistiques", label: "Statistiques" },
  { to: "/admin/parametres", label: "Paramètres système" },
  ...
  return (
    <div className={styles.page}>
      <header className={styles.topbar}>
        ...
        <span className={styles.title}>Espace administrateur</span>
